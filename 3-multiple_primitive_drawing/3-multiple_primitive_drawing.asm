...
drawSprite:
    ...
    ; you can draw several primitives of the same type, but don't forget to count the amount of data.
    ; For each sprite, you need to set two XYZ and one RGBAQ coordinates, which is 3 pieces of information. 
    ; Since there are 3 sprites, we'll need 9 pieces of information, plus one being the set reg prim, for a total of 10.
    dc64 GIF_TAG(10, 0, 0, 0, FLG_PACKED, 1), REG_A_D
